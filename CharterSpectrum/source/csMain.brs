' 
' Author: Satyanand
' Summary of last revision: $Id: csMain.brs 11188 2015-01-07 14:05:13Z tsatyananda2605 $
'
...
Function Main()
    ...
    ''Intialize Logger Value
    Logger().setLogLevel(5)
    
    ''Set Theme for Project
    InitTheme()
    
    ''Create Facade Screen which will be Bottom of Screens Stack
